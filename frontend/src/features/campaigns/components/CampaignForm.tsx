...
export default function CampaignForm({ mode, defaultValues, onSubmit, submitting }: Props) {
    const dv: CampaignFormValues = {
        ...
        town_id: defaultValues?.town_id ?? (0 as any),
    ...
    const debKw = useDebouncedValue(kwQuery, 300);
    const { data: kwOptions } = useKeywordTypeahead(debKw);
            ...
            <div className="card" style={{ marginBottom: 12 }}>
                ...
                <div className="form__row">
                    ...
                    <input
                        ...
                        disabled={submitting}
                    />
                    {debKw && kwOptions && kwOptions.length > 0 && (<div className="card" style={{ marginTop: 6 }}>
                        {kwOptions.map(k => (
                ...
                <div className="form__row">
                    ...
                    <MoneyInput placeholder={(MIN_BID_CENTS / 100).toFixed(2)}
                        value={watch('bid_amount')}
                        onValueChange={(v) => setValue('bid_amount', v, { shouldValidate: true })}
                        disabled={submitting}
                    />
                ...
                <div className="form__row">
                    ...
                    <MoneyInput placeholder="200,00"
                        value={watch('fund')}
                        onValueChange={(v) => setValue('fund', v, { shouldValidate: true })}
                        disabled={submitting}
                    />
